        ...
        <div class="card-container">
            ...
            <div class="card-wrapper">
                <div class="card">
                    ...
                    <h2>Holes</h2>
                    <p>Holes are traps in the maze. If the player slides into one, he falls and dies, forcing a restart. Players must avoid holes by planning their moves carefully.</p>
                </div>
            </div>
            <div class="card-wrapper">
                <div class="card">
